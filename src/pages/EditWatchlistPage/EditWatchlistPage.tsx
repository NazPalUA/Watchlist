...
function EditWatchlistPage({ className }: EditWatchlistPagePropTypes) {
  ...
  const { getWatchlistData, deleteWatchlist, editWatchlist, getMovieIds } =
  ...
  const moviesListHTML = moviesData.map((movie) => (
    <li className="edit-watchlist-page__movies-item" key={movie.id}>
      <img
      ...
      <p className="edit-watchlist-page__movie-name">
        {movie.title}{" "}
        <span className="edit-watchlist-page__movie-year">
  ...
  return (
    <div className={`edit-watchlist-page ${className}`}>
      <div className="edit-watchlist-page__top">
        <h4 className="edit-watchlist-page__header">Edit your Watchlist</h4>
        <button
      ...
      <form className="edit-watchlist-page__form" onSubmit={handleSubmit}>
        ...
        <input
          className="edit-watchlist-page__name"
          type="text"
          id="name"
          placeholder=""
        ...
        <textarea
          className="edit-watchlist-page__description"
          id="description"
          placeholder=""
          onChange={handleChange}
          name="description"
        ...
        <ul className="edit-watchlist-page__movies-list">{moviesListHTML}</ul>
        <div className="edit-watchlist-page__btns-container">
          <Link
            to={`/watchlist-page/${watchlistId}`}
            className="edit-watchlist-page__btn edit-watchlist-page__btn_dark"
          >
            Back
          </Link>
